 ...
 * ```
 */
export class ApplicationGateways extends Construct implements IApplicationGateway {
  /**
   ...
   */
  private resolveGatewayName(id: string, props: ApplicationGatewaysProps): string {
