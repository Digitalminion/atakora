 ...
 * ```
 */
export class VirtualNetworks extends Construct implements IVirtualNetwork {
  /**
   ...
   */
  private resolveVirtualNetworkName(id: string, props: VirtualNetworksProps): string {
