 ...
 * ```
 */
export class ActionGroups extends Construct implements IActionGroup {
  /**
   * Underlying L1 construct.
   */
  private readonly armActionGroup: ArmActionGroups;
  ...
  constructor(scope: Construct, id: string, props: ActionGroupsProps) {
    ...
    this.armActionGroup = new ArmActionGroups(scope, `${id}-Resource`, {
   ...
   */
  private resolveActionGroupName(id: string, props?: ActionGroupsProps): string {
