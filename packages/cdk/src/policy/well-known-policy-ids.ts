 ...
 * ```
 */
export class WellKnownPolicyIds {
  // ============================================================
  // Storage Policies
  // ============================================================
   ...
   */
  public static readonly STORAGE_HTTPS_ONLY = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly STORAGE_NETWORK_ACCESS_RESTRICTED = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly STORAGE_ALLOW_TRUSTED_SERVICES = WellKnownPolicyIds.policyId(
    'c9d007d0-c057-4772-b18c-01693b6f67ff'
  );
   ...
   * ```
   */
  public static readonly ALLOWED_LOCATIONS = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly ALLOWED_RESOURCE_GROUP_LOCATIONS = WellKnownPolicyIds.policyId(
   ...
   * ```
   */
  public static readonly REQUIRE_TAG_ON_RESOURCES = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly REQUIRE_TAG_ON_RESOURCE_GROUPS = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly INHERIT_TAG_FROM_RESOURCE_GROUP = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly NETWORK_INTERFACE_DISABLE_IP_FORWARDING = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly NETWORK_INTERFACE_NO_PUBLIC_IP = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly AUDIT_VM_MANAGED_DISKS = WellKnownPolicyIds.policyId(
   ...
   * ```
   */
  public static readonly ALLOWED_VM_SKUS = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly VM_ENCRYPTION_AT_HOST = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly AUDIT_CUSTOM_RBAC_ROLES = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly KEY_VAULT_PURGE_PROTECTION = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly KEY_VAULT_SOFT_DELETE = WellKnownPolicyIds.policyId(
   ...
   */
  public static readonly MONITOR_LOG_PROFILE_CATEGORIES = WellKnownPolicyIds.policyId(
   ...
   * @internal
   */
  private static policyId(guid: string): string {
    // Built-in policies are at provider level (no subscription)
