...
exports.ProblemDetailsValidator = exports.ProblemDetailsFactory = void 0;
/**
...
class ProblemDetailsFactory {
     ...
     * ```
     */
    static unprocessableEntity(detail, errors) {
        return {
     ...
     * ```
     */
    static tooManyRequests(detail, retryAfter) {
        return {
     ...
     * ```
     */
    static serviceUnavailable(detail, retryAfter) {
        return {
     ...
     * ```
     */
    static custom(status, type, title, detail, extensions) {
        return {
            type,
            title,
            status,
     ...
     * ```
     */
    static withTraceId(problem, traceId) {
        return {
            ...problem,
            traceId,
        };
     ...
     * ```
     */
    static withInstance(problem, instance) {
        return {
            ...problem,
            instance,
        };
     ...
     * ```
     */
    static withExtensions(problem, extensions) {
        return {
            ...problem,
            ...extensions,
        };
...
class ProblemDetailsValidator {
    ...
    static isValid(problem) {
        ...
        if (p.instance !== undefined && typeof p.instance !== 'string')
            return false;
        if (p.traceId !== undefined && typeof p.traceId !== 'string')
            return false;
...
exports.ProblemDetailsValidator = ProblemDetailsValidator;
