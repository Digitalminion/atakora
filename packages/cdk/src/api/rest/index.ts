/**
 * REST API Core Foundation
 *
 * Provides type-safe REST API operation definitions with OpenAPI 3.0/3.1 compatibility.
 * Includes fluent builders, backend integration, and full TypeScript type inference.
 *
