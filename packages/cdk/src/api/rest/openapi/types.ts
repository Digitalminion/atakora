...
export interface SchemaObject {
  ...
  readonly exclusiveMaximum?: boolean | number; // boolean in 3.0, number in 3.1
  readonly minimum?: number;
  readonly exclusiveMinimum?: boolean | number; // boolean in 3.0, number in 3.1
  ...
  readonly nullable?: boolean; // OpenAPI 3.0 only (deprecated in 3.1)
...
export interface ReferenceObject {
  readonly $ref: string;
  readonly summary?: string; // OpenAPI 3.1 only
  readonly description?: string; // OpenAPI 3.1 only
}
