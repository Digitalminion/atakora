 ...
 */
export declare const ActivityLogAlertField: typeof schema.insights.ActivityLogAlertField;
 ...
 */
export declare const ActivityLogAlertCategory: typeof schema.insights.ActivityLogAlertCategory;
 ...
 */
export declare const ActivityLogAlertLevel: typeof schema.insights.ActivityLogAlertLevel;
 ...
 */
export declare const ActivityLogAlertStatus: typeof schema.insights.ActivityLogAlertStatus;
 ...
 */
export declare const ServiceHealthEventType: typeof schema.insights.ServiceHealthEventType;
export type ServiceHealthEventType = typeof ServiceHealthEventType[keyof typeof ServiceHealthEventType];
/**
 * Resource health status.
 */
export declare const ResourceHealthStatus: typeof schema.insights.ResourceHealthStatus;
...
//# sourceMappingURL=activity-log-alert-types.d.ts.map