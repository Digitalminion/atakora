 ...
 */
export declare const SubscriptionLogCategory: typeof schema.insights.SubscriptionLogCategory;
...
//# sourceMappingURL=diagnostic-setting-subscription-types.d.ts.map