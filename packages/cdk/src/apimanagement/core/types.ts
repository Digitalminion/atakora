 ...
 * ```
 */
export interface ArmServiceProps {
  /**
...
export interface ApiManagementSubscriptionProps {
   ...
   */
  readonly scopeProduct?: IServiceProduct;
...
export interface ArmApiManagementPolicyProps {
   ...
   */
  readonly parent: IService | IServiceApi;
