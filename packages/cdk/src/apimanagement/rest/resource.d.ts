 ...
 * ```
 */
export declare function createRestApi(scope: Construct, apiManagementService: IService, apiConfigs: ApiConfig[]): RestApiStack;
/**
 ...
 * ```
 */
export declare function createCrudApi(scope: Construct, apiManagementService: IService, config: ApiConfig): RestApiStack;
/**
 ...
 * ```
 */
export declare function createAsyncApi(scope: Construct, apiManagementService: IService, config: ApiConfig): RestApiStack;
/**
 ...
 * ```
 */
export declare function createCatalogApi(scope: Construct, apiManagementService: IService, config: ApiConfig): RestApiStack;
/**
