 ...
 * ```
 */
export class PrivateEndpoints extends Construct implements IPrivateEndpoint {
  /**
   ...
   */
  private resolveLocation(scope: Construct, props: PrivateEndpointsProps): string {
   ...
   */
  private resolvePrivateEndpointName(id: string, props: PrivateEndpointsProps): string {
   ...
   */
  private buildDnsZoneGroup(props: PrivateEndpointsProps): PrivateDnsZoneGroup | undefined {
