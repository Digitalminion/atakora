...
export interface InlineSubnetProps {
     ...
     */
    readonly serviceEndpoints?: Array<{
        service: string;
    }>;
    /**
...
/**
 * Properties for VirtualNetworks (L2 construct).
 *
 * @remarks
 ...
 * ```
 */
export interface VirtualNetworksProps {
    /**
     * Name of the virtual network.
     *
     * @remarks
...
//# sourceMappingURL=virtual-network-types.d.ts.map