 ...
 */
export declare const PrivateEndpointNetworkPolicies: typeof schema.network.PrivateEndpointNetworkPolicies;
 ...
 */
export declare const PrivateLinkServiceNetworkPolicies: typeof schema.network.PrivateLinkServiceNetworkPolicies;
 ...
 */
export declare const SharingScope: typeof schema.network.SharingScope;
...
//# sourceMappingURL=subnet-types.d.ts.map