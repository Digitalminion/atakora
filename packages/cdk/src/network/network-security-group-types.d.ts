 ...
 */
export declare const SecurityRuleProtocol: typeof schema.network.SecurityRuleProtocol;
export type SecurityRuleProtocol = typeof SecurityRuleProtocol[keyof typeof SecurityRuleProtocol];
/**
 * Access type for security rules.
 */
export declare const SecurityRuleAccess: typeof schema.network.SecurityRuleAccess;
export type SecurityRuleAccess = typeof SecurityRuleAccess[keyof typeof SecurityRuleAccess];
/**
 * Direction for security rules.
 */
export declare const SecurityRuleDirection: typeof schema.network.SecurityRuleDirection;
 ...
 * ```
 */
export interface NetworkSecurityGroupsProps {
    /**
     * Name of the network security group.
     *
     * @remarks
...
//# sourceMappingURL=network-security-group-types.d.ts.map