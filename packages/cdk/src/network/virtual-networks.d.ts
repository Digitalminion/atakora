...
import type { VirtualNetworksProps, IVirtualNetwork, AddressSpace, InlineSubnetProps } from './virtual-network-types';
/**
 ...
 * ```
 */
export declare class VirtualNetworks extends Construct implements IVirtualNetwork {
    /**
     * Underlying L1 construct.
     */
    private readonly armVirtualNetwork;
    /**
     ...
     * ```
     */
    addSubnet(props: InlineSubnetProps): any;
}
