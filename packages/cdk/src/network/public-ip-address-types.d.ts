 ...
 */
export declare const PublicIPAddressSku: typeof schema.network.PublicIPAddressSku;
 ...
 */
export declare const PublicIPAllocationMethod: typeof schema.network.PublicIPAllocationMethod;
export type PublicIPAllocationMethod = typeof PublicIPAllocationMethod[keyof typeof PublicIPAllocationMethod];
/**
 * IP address version.
 */
export declare const IpVersion: typeof schema.network.IpVersion;
...
//# sourceMappingURL=public-ip-address-types.d.ts.map