 ...
 */
export declare const SignalRSku: typeof schema.signalr.SignalRSku;
export type SignalRSku = typeof SignalRSku[keyof typeof SignalRSku];
/**
 * SignalR Service mode.
 */
export declare const ServiceMode: typeof schema.signalr.ServiceMode;
export type ServiceMode = typeof ServiceMode[keyof typeof ServiceMode];
/**
 * Feature flags for SignalR Service.
 */
export declare const FeatureFlag: typeof schema.signalr.FeatureFlag;
 ...
 * Network ACL action.
 */
export declare const AclAction: typeof schema.signalr.AclAction;
export type AclAction = typeof AclAction[keyof typeof AclAction];
/**
 * Public network access.
 */
export declare const PublicNetworkAccess: typeof schema.signalr.PublicNetworkAccess;
...
//# sourceMappingURL=signalr-service-types.d.ts.map