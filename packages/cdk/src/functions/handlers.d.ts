 ...
 * ```
 */
import type { AzureFunctionContext, HttpRequest, HttpResponse, TimerInfo } from './types';
/**
 ...
 */
export type AzureFunctionHandler<TInput = unknown, TOutput = unknown> = (context: AzureFunctionContext, input: TInput) => Promise<TOutput> | TOutput;
/**
 ...
 * ```
 */
export type HttpHandler = (context: AzureFunctionContext, req: HttpRequest) => Promise<HttpResponse> | HttpResponse;
/**
 ...
 * ```
 */
export type TimerHandler = (context: AzureFunctionContext, timer: TimerInfo) => Promise<void> | void;
/**
 ...
 * ```
 */
export type QueueHandler<T = any> = (context: AzureFunctionContext, message: QueueMessage<T>) => Promise<void> | void;
/**
 ...
 * ```
 */
export type ServiceBusQueueHandler<T = any> = (context: AzureFunctionContext, message: ServiceBusMessage<T>) => Promise<void> | void;
/**
 ...
 * ```
 */
export type ServiceBusTopicHandler<T = any> = (context: AzureFunctionContext, message: ServiceBusMessage<T>) => Promise<void> | void;
/**
 ...
 * ```
 */
export type EventHubHandler<T = any> = (context: AzureFunctionContext, events: readonly EventHubEvent<T>[]) => Promise<void> | void;
/**
 ...
 * ```
 */
export type CosmosDBHandler<T = any> = (context: AzureFunctionContext, documents: readonly CosmosDocument<T>[]) => Promise<void> | void;
/**
 ...
 * ```
 */
export type EventGridHandler<T = any> = (context: AzureFunctionContext, event: EventGridEvent<T>) => Promise<void> | void;
/**
 ...
 * ```
 */
export type IoTHubHandler<T = any> = (context: AzureFunctionContext, messages: readonly IoTHubMessage<T>[]) => Promise<void> | void;
/**
 ...
 * ```
 */
export type KafkaHandler<T = any> = (context: AzureFunctionContext, events: readonly KafkaEvent<T>[]) => Promise<void> | void;
/**
 ...
 * ```
 */
export type RabbitMQHandler<T = any> = (context: AzureFunctionContext, message: RabbitMQMessage<T>) => Promise<void> | void;
/**
 ...
 * ```
 */
export type RedisStreamHandler = (context: AzureFunctionContext, entries: readonly RedisStreamEntry[]) => Promise<void> | void;
/**
...
export interface DurableOrchestrationContext extends AzureFunctionContext {
     ...
     */
    callSubOrchestrator<TInput = any, TOutput = any>(name: string, input?: TInput, instanceId?: string): Promise<TOutput>;
    /**
 ...
 * ```
 */
export type DurableOrchestratorHandler<TInput = any, TOutput = any> = (context: DurableOrchestrationContext) => Generator<any, TOutput, any>;
/**
 ...
 * ```
 */
export type DurableActivityHandler<TInput = any, TOutput = any> = (context: AzureFunctionContext, input: TInput) => Promise<TOutput> | TOutput;
/**
 ...
 * ```
 */
export type DurableEntityHandler<TState = any> = (context: DurableEntityContext) => Promise<any> | any;
/**
 ...
 */
export type AnyFunctionHandler = HttpHandler | TimerHandler | QueueHandler | BlobHandler | ServiceBusQueueHandler | ServiceBusTopicHandler | EventHubHandler | CosmosDBHandler | EventGridHandler | IoTHubHandler | SignalRNegotiateHandler | KafkaHandler | RabbitMQHandler | RedisStreamHandler | DurableOrchestratorHandler | DurableActivityHandler | DurableEntityHandler;
