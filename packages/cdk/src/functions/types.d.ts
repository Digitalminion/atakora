 ...
 */
export declare class DurationFactory {
    /**
 ...
 */
export type TriggerConfig = HttpTriggerConfig | TimerTriggerConfig | QueueTriggerConfig | ServiceBusTriggerConfig | CosmosTriggerConfig | EventHubTriggerConfig | BlobTriggerConfig;
/**
 ...
 */
export type BindingConfig = BlobBindingConfig | QueueBindingConfig | TableBindingConfig | CosmosBindingConfig | SignalRBindingConfig;
/**
 ...
 */
export type QueueHandler<T = any> = (context: AzureFunctionContext, message: T) => Promise<void> | void;
/**
 * Service Bus handler function type.
 */
export type ServiceBusHandler<T = any> = (context: AzureFunctionContext, message: T, metadata?: MessageMetadata) => Promise<void> | void;
/**
 * Event handler function type.
 */
export type EventHandler<T = any> = (context: AzureFunctionContext, event: T) => Promise<void> | void;
/**
 * Generic function handler type.
 */
export type FunctionHandler = HttpHandler | TimerHandler | QueueHandler | ServiceBusHandler | EventHandler;
