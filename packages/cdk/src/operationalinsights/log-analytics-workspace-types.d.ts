...
export declare const WorkspaceSku: typeof schema.operationalinsights.WorkspaceSku;
export declare const PublicNetworkAccess: typeof schema.operationalinsights.PublicNetworkAccess;
 ...
 * @example
 * ```typescript
 * const props: ArmWorkspacesProps = {
...
//# sourceMappingURL=log-analytics-workspace-types.d.ts.map