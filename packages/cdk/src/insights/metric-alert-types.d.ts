 ...
 */
export declare const TimeAggregation: typeof schema.insights.TimeAggregation;
export type TimeAggregation = typeof TimeAggregation[keyof typeof TimeAggregation];
/**
 * Alert sensitivity for dynamic thresholds.
 */
export declare const DynamicThresholdSensitivity: typeof schema.insights.DynamicThresholdSensitivity;
...
//# sourceMappingURL=metric-alert-types.d.ts.map