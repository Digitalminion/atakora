 ...
 */
export declare const ApplicationType: typeof schema.insights.ApplicationType;
export type ApplicationType = typeof ApplicationType[keyof typeof ApplicationType];
/**
 * Request source for Application Insights.
 */
export declare const RequestSource: typeof schema.insights.RequestSource;
export type RequestSource = typeof RequestSource[keyof typeof RequestSource];
/**
 * Flow type for Application Insights.
 */
export declare const FlowType: typeof schema.insights.FlowType;
export type FlowType = typeof FlowType[keyof typeof FlowType];
/**
 * Public network access options.
 */
export declare const PublicNetworkAccess: typeof schema.insights.PublicNetworkAccess;
export type PublicNetworkAccess = typeof PublicNetworkAccess[keyof typeof PublicNetworkAccess];
/**
 * Ingestion mode for Application Insights.
 */
export declare const IngestionMode: typeof schema.insights.IngestionMode;
...
//# sourceMappingURL=application-insights-types.d.ts.map