 ...
 */
export declare const ServerFarmSkuName: typeof schema.web.ServerFarmSkuName;
export type ServerFarmSkuName = typeof ServerFarmSkuName[keyof typeof ServerFarmSkuName];
/**
 * SKU tier for Server Farm.
 */
export declare const ServerFarmSkuTier: typeof schema.web.ServerFarmSkuTier;
export type ServerFarmSkuTier = typeof ServerFarmSkuTier[keyof typeof ServerFarmSkuTier];
/**
 * Kind of Server Farm.
 */
export declare const ServerFarmKind: typeof schema.web.ServerFarmKind;
...
//# sourceMappingURL=server-farm-types.d.ts.map