 ...
 */
export declare const FunctionRuntime: typeof schema.web.FunctionRuntime;
export type FunctionRuntime = typeof FunctionRuntime[keyof typeof FunctionRuntime];
/**
 * Authentication level for HTTP triggers.
 */
export declare const AuthLevel: typeof schema.web.AuthLevel;
export type AuthLevel = typeof AuthLevel[keyof typeof AuthLevel];
/**
 * HTTP methods.
 */
export declare const HttpMethod: typeof schema.web.HttpMethod;
export type HttpMethod = typeof HttpMethod[keyof typeof HttpMethod];
/**
 * FTPS state for the Function App.
 */
export declare const FtpsState: typeof schema.web.FtpsState;
export type FtpsState = typeof FtpsState[keyof typeof FtpsState];
/**
 * Minimum TLS version.
 */
export declare const MinTlsVersion: typeof schema.web.MinTlsVersion;
 ...
 */
export type TriggerConfig = HttpTriggerConfig | TimerTriggerConfig | QueueTriggerConfig | BlobTriggerConfig | ServiceBusQueueTriggerConfig | ServiceBusTopicTriggerConfig | EventHubTriggerConfig | CosmosDBTriggerConfig | EventGridTriggerConfig | IoTHubTriggerConfig | SignalRTriggerConfig | KafkaTriggerConfig | RabbitMQTriggerConfig | RedisStreamTriggerConfig | DurableOrchestratorTriggerConfig | DurableActivityTriggerConfig | DurableEntityTriggerConfig;
/**
...
//# sourceMappingURL=function-app-types.d.ts.map