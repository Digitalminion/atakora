 ...
 */
export declare const RedisCacheSku: typeof schema.cache.RedisCacheSku;
export type RedisCacheSku = typeof RedisCacheSku[keyof typeof RedisCacheSku];
/**
 * SKU family.
 */
export declare const SkuFamily: typeof schema.cache.SkuFamily;
export type SkuFamily = typeof SkuFamily[keyof typeof SkuFamily];
/**
 * Minimum TLS version.
 */
export declare const TlsVersion: typeof schema.cache.TlsVersion;
export type TlsVersion = typeof TlsVersion[keyof typeof TlsVersion];
/**
 * Public network access setting.
 */
export declare const PublicNetworkAccess: typeof schema.cache.PublicNetworkAccess;
...
//# sourceMappingURL=redis-cache-types.d.ts.map