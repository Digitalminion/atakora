...
import { ManagementGroupArm } from './management-group-arm';
 ...
 * ```
 */
export class ManagementGroup extends Construct {
  /**
   * Underlying L1 construct.
   * @internal
   */
  private readonly armManagementGroup: ManagementGroupArm;
  ...
  constructor(scope: Construct, id: string, props: ManagementGroupProps) {
    ...
    // Store properties
    this.managementGroupName = props.name;
    this.displayName = props.displayName;

    // Create underlying L1 resource
    this.armManagementGroup = new ManagementGroupArm(this, 'Resource', {
      managementGroupName: props.name,
      displayName: props.displayName,
      parentId: props.parentId,
      description: props.description,
    });

    this.managementGroupId = this.armManagementGroup.resourceId;
  }
