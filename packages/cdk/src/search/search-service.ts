 ...
 * ```
 */
export class SearchServices extends Construct implements ISearchService {
  /**
   * Underlying L1 construct.
   */
  private readonly armSearchService: ArmSearchServices;
  ...
  constructor(scope: Construct, id: string, props?: SearchServicesProps) {
    ...
    this.armSearchService = new ArmSearchServices(scope, `${id}-Resource`, {
   ...
   */
  private resolveServiceName(id: string, props?: SearchServicesProps): string {
