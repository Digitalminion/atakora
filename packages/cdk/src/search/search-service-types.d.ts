 ...
 */
export declare const SearchServiceSku: typeof schema.search.SearchServiceSku;
export type SearchServiceSku = typeof SearchServiceSku[keyof typeof SearchServiceSku];
/**
 * Hosting mode for search service.
 */
export declare const HostingMode: typeof schema.search.HostingMode;
export type HostingMode = typeof HostingMode[keyof typeof HostingMode];
/**
 * Public network access setting.
 */
export declare const PublicNetworkAccess: typeof schema.search.PublicNetworkAccess;
...
//# sourceMappingURL=search-service-types.d.ts.map