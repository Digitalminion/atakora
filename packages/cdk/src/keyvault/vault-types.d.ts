 ...
 * Key Vault SKU names.
 */
export declare const KeyVaultSkuName: typeof schema.keyvault.KeyVaultSkuName;
export type KeyVaultSkuName = typeof KeyVaultSkuName[keyof typeof KeyVaultSkuName];
/**
 * Public network access options.
 */
export declare const PublicNetworkAccess: typeof schema.keyvault.PublicNetworkAccess;
 ...
 */
export declare const NetworkAclBypass: typeof schema.keyvault.NetworkAclBypass;
export type NetworkAclBypass = typeof NetworkAclBypass[keyof typeof NetworkAclBypass];
/**
 * Network ACL default action.
 */
export declare const NetworkAclDefaultAction: typeof schema.keyvault.NetworkAclDefaultAction;
