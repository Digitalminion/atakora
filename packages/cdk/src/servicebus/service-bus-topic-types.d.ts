 ...
 */
export declare const EntityStatus: typeof schema.servicebus.EntityStatus;
 ...
 */
export declare const FilterType: typeof schema.servicebus.FilterType;
...
//# sourceMappingURL=service-bus-topic-types.d.ts.map