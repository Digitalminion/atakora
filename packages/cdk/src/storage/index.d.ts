...
export type { ArmStorageAccountsProps, StorageAccountsProps, IStorageAccount, StorageAccountSku, NetworkAcls, } from './storage-account-types';
export { StorageAccountSkuName, StorageAccountKind, AccessTier, TlsVersion, PublicNetworkAccess, NetworkAclDefaultAction, NetworkAclBypass, } from './storage-account-types';
