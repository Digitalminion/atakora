...
- [Schema Reference](../../docs/reference/backend/schema.md) - All model types and features
- [Authentication](../../docs/reference/backend/authentication.md) - Auth configuration
- [Design Defaults](../../docs/reference/backend/design/) - What defaults provide
