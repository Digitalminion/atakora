 ...
 */
export type AuthorizationRuleFunction = (
 ...
 */
export type LifecycleHook<TOperation extends string> = (
  data: any,
  context: LifecycleHookContext<TOperation>
) => any | Promise<any>;
 ...
 */
export type InferSchemaType<TSchema extends SchemaDefinition<any>> =
  TSchema extends SchemaDefinition<infer TFields>
    ? z.infer<z.ZodObject<TFields>> & {
