...
import { RoleAssignment, RoleAssignmentProps } from './role-assignment';
...
export class CrossStackGrant {
  ...
  public static create(
    ...
    return new RoleAssignment(scope, id, roleAssignmentProps);
  }
  ...
  public static createMultiple(
    ...
    baseId: string,
    grantee: IGrantable,
    grants: ReadonlyArray<CrossStackGrantMultipleProps>
  ): RoleAssignment[] {
    return grants.map((grant, index) =>
      CrossStackGrant.create(scope, `${baseId}${index}`, {
