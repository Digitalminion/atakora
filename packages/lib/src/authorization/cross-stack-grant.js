...
exports.CrossStackGrant = void 0;
 ...
 * ```
 */
var CrossStackGrant = /** @class */ (function () {
    function CrossStackGrant() {
    }
    /**
     ...
     * ```
     */
    CrossStackGrant.create = function (scope, id, props) {
        var roleAssignmentProps = {
            scope: props.resource.resourceId,
            roleDefinitionId: props.roleDefinitionId,
            principalId: props.grantee.principalId,
            principalType: props.grantee.principalType,
            tenantId: props.grantee.tenantId,
            description: props.description,
        };
        return new role_assignment_1.RoleAssignment(scope, id, roleAssignmentProps);
    };
    /**
     ...
     * ```
     */
    CrossStackGrant.createMultiple = function (scope, baseId, grantee, grants) {
        return grants.map(function (grant, index) {
            return CrossStackGrant.create(scope, "".concat(baseId).concat(index), {
    ...
    return CrossStackGrant;
}());
exports.CrossStackGrant = CrossStackGrant;
