...
export class WellKnownRoleIds {
   ...
   */
  public static readonly API_MANAGEMENT_SERVICE_CONTRIBUTOR = WellKnownRoleIds.roleId(
   ...
   */
  public static readonly API_MANAGEMENT_SERVICE_OPERATOR = WellKnownRoleIds.roleId(
   ...
   */
  public static readonly API_MANAGEMENT_SERVICE_READER = WellKnownRoleIds.roleId(
   ...
   */
  public static readonly API_MANAGEMENT_DEVELOPER_PORTAL_CONTENT_EDITOR = WellKnownRoleIds.roleId(
   ...
   */
  public static readonly API_MANAGEMENT_WORKSPACE_CONTRIBUTOR = WellKnownRoleIds.roleId(
