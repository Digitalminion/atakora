 ...
 * ```
 */
export declare function grantResourceRole(scope: Construct, id: string, props: GrantResourceRoleProps): RoleAssignment;
//# sourceMappingURL=grant-resource-role.d.ts.map