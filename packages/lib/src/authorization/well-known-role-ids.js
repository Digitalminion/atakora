...
exports.WellKnownRoleIds = void 0;
/**
 ...
 * ```
 */
var WellKnownRoleIds = /** @class */ (function () {
    function WellKnownRoleIds() {
    }
    /**
     ...
     * @internal
     */
    WellKnownRoleIds.roleId = function (guid) {
        ...
        return "[subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '".concat(guid, "')]");
    };
    // ============================================================
     ...
     */
    WellKnownRoleIds.READER = WellKnownRoleIds.roleId('acdd72a7-3385-48ef-bd42-f606fba81ae7');
    /**
     ...
     */
    WellKnownRoleIds.CONTRIBUTOR = WellKnownRoleIds.roleId('b24988ac-6180-42a0-ab88-20f7382dd24c');
    /**
     ...
     */
    WellKnownRoleIds.OWNER = WellKnownRoleIds.roleId('8e3af657-a8ff-443c-a75c-2fe8c4bcb635');
    /**
     ...
     */
    WellKnownRoleIds.USER_ACCESS_ADMINISTRATOR = WellKnownRoleIds.roleId('18d7d88d-d35e-4fb5-a5c3-7773c20a72d9');
    // ============================================================
    // Storage Account - Blob Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_BLOB_DATA_READER = WellKnownRoleIds.roleId('2a2b9908-6ea1-4ae2-8e65-a410df84e7d1');
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_BLOB_DATA_CONTRIBUTOR = WellKnownRoleIds.roleId('ba92f5b4-2d11-453d-a403-e96b0029c9fe');
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_BLOB_DATA_OWNER = WellKnownRoleIds.roleId('b7e6dc6d-f1e8-4753-8033-0f276bb0955b');
    // ============================================================
    // Storage Account - Queue Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_QUEUE_DATA_READER = WellKnownRoleIds.roleId('19e7f393-937e-4f77-808e-94535e297925');
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_QUEUE_DATA_CONTRIBUTOR = WellKnownRoleIds.roleId('974c5e8b-45b9-4653-ba55-5f855dd0fb88');
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_QUEUE_DATA_MESSAGE_SENDER = WellKnownRoleIds.roleId('c6a89b2d-59bc-44d0-9896-0f6e12d7b80a');
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_QUEUE_DATA_MESSAGE_PROCESSOR = WellKnownRoleIds.roleId('8a0f0c08-91a1-4084-bc3d-661d67233fed');
    // ============================================================
    // Storage Account - Table Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_TABLE_DATA_READER = WellKnownRoleIds.roleId('76199698-9eea-4c19-bc75-cec21354c6b6');
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_TABLE_DATA_CONTRIBUTOR = WellKnownRoleIds.roleId('0a9a7e1f-b9d0-4cc4-a60d-0319b160aaa3');
    // ============================================================
    // Storage Account - File Share Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_FILE_DATA_SMB_SHARE_READER = WellKnownRoleIds.roleId('aba4ae5f-2193-4029-9191-0cb91df5e314');
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_FILE_DATA_SMB_SHARE_CONTRIBUTOR = WellKnownRoleIds.roleId('0c867c2a-1d8c-454a-a3db-ab2ea1bdc8bb');
    /**
     ...
     */
    WellKnownRoleIds.STORAGE_FILE_DATA_SMB_SHARE_ELEVATED_CONTRIBUTOR = WellKnownRoleIds.roleId('a7264617-510b-434b-a828-9731dc254ea7');
    // ============================================================
    // Cosmos DB Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.COSMOS_DB_ACCOUNT_READER = WellKnownRoleIds.roleId('fbdf93bf-df7d-467e-a4d2-9458aa1360c8');
    /**
     ...
     */
    WellKnownRoleIds.COSMOS_DB_OPERATOR = WellKnownRoleIds.roleId('230815da-be43-4aae-9cb4-875f7bd000aa');
    /**
     ...
     */
    WellKnownRoleIds.COSMOS_DB_DATA_READER = WellKnownRoleIds.roleId('00000000-0000-0000-0000-000000000001');
    /**
     ...
     */
    WellKnownRoleIds.COSMOS_DB_DATA_CONTRIBUTOR = WellKnownRoleIds.roleId('00000000-0000-0000-0000-000000000002');
    // ============================================================
    // Key Vault Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.KEY_VAULT_SECRETS_USER = WellKnownRoleIds.roleId('4633458b-17de-408a-b874-0445c86b69e6');
    /**
     ...
     */
    WellKnownRoleIds.KEY_VAULT_SECRETS_OFFICER = WellKnownRoleIds.roleId('b86a8fe4-44ce-4948-aee5-eccb2c155cd7');
    /**
     ...
     */
    WellKnownRoleIds.KEY_VAULT_CRYPTO_USER = WellKnownRoleIds.roleId('12338af0-0e69-4776-bea7-57ae8d297424');
    /**
     ...
     */
    WellKnownRoleIds.KEY_VAULT_CRYPTO_OFFICER = WellKnownRoleIds.roleId('14b46e9e-c2b7-41b4-b07b-48a6ebf60603');
    /**
     * Read certificates.
     *
     * @remarks
     ...
     */
    WellKnownRoleIds.KEY_VAULT_CERTIFICATES_USER = WellKnownRoleIds.roleId('db79e9a7-68ee-4b58-9aeb-b90e7c24fcba');
    /**
     * Manage certificates.
     *
     * @remarks
     ...
     */
    WellKnownRoleIds.KEY_VAULT_CERTIFICATES_OFFICER = WellKnownRoleIds.roleId('a4417e6f-fecd-4de8-b567-7b0420556985');
    /**
     ...
     */
    WellKnownRoleIds.KEY_VAULT_READER = WellKnownRoleIds.roleId('21090545-7ca7-4776-b22c-e363652d74d2');
    /**
     ...
     */
    WellKnownRoleIds.KEY_VAULT_ADMINISTRATOR = WellKnownRoleIds.roleId('00482a5a-887f-4fb3-b363-3b7fe8e74483');
    // ============================================================
     ...
     */
    WellKnownRoleIds.WEBSITE_CONTRIBUTOR = WellKnownRoleIds.roleId('de139f84-1756-47ae-9be6-808fbbe84772');
    /**
     ...
     */
    WellKnownRoleIds.WEB_PLAN_CONTRIBUTOR = WellKnownRoleIds.roleId('2cc479cb-7b4d-49a8-b449-8c00fd0f0a4b');
    // ============================================================
    // SQL Database Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.SQL_DB_CONTRIBUTOR = WellKnownRoleIds.roleId('9b7fa17d-e63e-47b0-bb0a-15c516ac86ec');
    /**
     ...
     */
    WellKnownRoleIds.SQL_SECURITY_MANAGER = WellKnownRoleIds.roleId('056cd41c-7e88-42e1-933e-88ba6a50c9c3');
    /**
     * Manage SQL servers.
     *
     * @remarks
     ...
     */
    WellKnownRoleIds.SQL_SERVER_CONTRIBUTOR = WellKnownRoleIds.roleId('6d8ee4ec-f05a-4a1d-8b00-a9b17e38b437');
    // ============================================================
    // Event Hub Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.EVENT_HUB_DATA_RECEIVER = WellKnownRoleIds.roleId('a638d3c7-ab3a-418d-83e6-5f17a39d4fde');
    /**
     * Send Event Hub data.
     *
     * @remarks
     ...
     */
    WellKnownRoleIds.EVENT_HUB_DATA_SENDER = WellKnownRoleIds.roleId('2b629674-e913-4c01-ae53-ef4638d8f975');
    /**
     * Manage Event Hubs.
     *
     * @remarks
     ...
     */
    WellKnownRoleIds.EVENT_HUB_DATA_OWNER = WellKnownRoleIds.roleId('f526a384-b230-433a-b45c-95f59c4a2dec');
    // ============================================================
    // Service Bus Roles
    // ============================================================
    /**
     ...
     */
    WellKnownRoleIds.SERVICE_BUS_DATA_RECEIVER = WellKnownRoleIds.roleId('4f6d3b9b-027b-4f4c-9142-0e5a2a2247e0');
    /**
     ...
     */
    WellKnownRoleIds.SERVICE_BUS_DATA_SENDER = WellKnownRoleIds.roleId('69a216fc-b8fb-44d8-bc22-1f3c2cd27a39');
    /**
     ...
     */
    WellKnownRoleIds.SERVICE_BUS_DATA_OWNER = WellKnownRoleIds.roleId('090c5cfd-751d-490a-894a-3ce6f1109419');
    // ============================================================
     ...
     */
    WellKnownRoleIds.API_MANAGEMENT_SERVICE_CONTRIBUTOR = WellKnownRoleIds.roleId('312a565d-c81f-4fd8-895a-4e21e48d571c');
    /**
     ...
     */
    WellKnownRoleIds.API_MANAGEMENT_SERVICE_OPERATOR = WellKnownRoleIds.roleId('e022efe7-f5ba-4159-bbe4-b44f577e9b61');
    /**
     ...
     */
    WellKnownRoleIds.API_MANAGEMENT_SERVICE_READER = WellKnownRoleIds.roleId('71522526-b88f-4d52-b57f-d31fc3546d0d');
    /**
     ...
     */
    WellKnownRoleIds.API_MANAGEMENT_DEVELOPER_PORTAL_CONTENT_EDITOR = WellKnownRoleIds.roleId('c031e6a8-4391-4de0-8d69-4706a7ed3729');
    /**
     ...
     */
    WellKnownRoleIds.API_MANAGEMENT_WORKSPACE_CONTRIBUTOR = WellKnownRoleIds.roleId('56328988-075d-4c6a-8766-d93edd6725b6');
    // ============================================================
     ...
     */
    WellKnownRoleIds.ACR_PULL = WellKnownRoleIds.roleId('7f951dda-4ed3-4680-a7ca-43fe172d538d');
    /**
     ...
     */
    WellKnownRoleIds.ACR_PUSH = WellKnownRoleIds.roleId('8311e382-0749-4cb8-b61a-304f252e45ec');
    /**
     ...
     */
    WellKnownRoleIds.ACR_DELETE = WellKnownRoleIds.roleId('c2f4ef07-c644-48eb-af81-4b1b4947fb11');
    return WellKnownRoleIds;
}());
exports.WellKnownRoleIds = WellKnownRoleIds;
