 ...
 */
export type AuthenticationProvider = 'azuread' | 'azureadb2c' | 'apikey' | 'jwt' | 'oauth2' | 'custom';
/**
 ...
 */
export type AzureEnvironment = 'AzureCloud' | 'AzureUSGovernment' | 'AzureChinaCloud' | 'AzureGermanCloud';
/**
