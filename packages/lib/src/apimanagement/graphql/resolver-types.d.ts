 ...
 */
export type ResolverFunction<TSource = any, TContext = any, TArgs = any, TReturn = any> = (source: TSource, args: TArgs, context: TContext, info: GraphQLResolveInfo) => Promise<TReturn> | TReturn;
/**
 ...
 */
export type AuthorizationStrategy = 'any' | 'all' | 'custom';
/**
 * Authorization rule
 */
 ...
 * Authorization types
 */
export type AuthorizationType = 'role' | 'claim' | 'attribute' | 'policy' | 'custom';
/**
 * Authorization configuration (discriminated union)
 */
export type AuthorizationConfig = RoleAuthorizationConfig | ClaimAuthorizationConfig | AttributeAuthorizationConfig | PolicyAuthorizationConfig | CustomAuthorizationConfig;
/**
 ...
 */
export type AuthorizationHandler = (context: any, source: any, args: any, info: GraphQLResolveInfo) => Promise<boolean> | boolean;
/**
...
//# sourceMappingURL=resolver-types.d.ts.map