 ...
 */
export type GraphQLScalarType = 'ID' | 'String' | 'Int' | 'Float' | 'Boolean' | 'DateTime' | 'Date' | 'Time' | 'JSON' | 'JSONObject' | 'UUID' | 'Email' | 'URL' | 'PhoneNumber' | 'PostalCode' | 'BigInt' | 'Long' | 'Byte';
/**
 ...
 */
export type ResolveTypeFn<TSource = any, TContext = any> = (value: TSource, context: TContext, info: any) => string | Promise<string>;
/**
 ...
 */
export type GraphQLTypeDefinition = IGraphQLObjectType | IGraphQLInputObjectType | IGraphQLEnumType | IGraphQLInterfaceType | IGraphQLUnionType | IGraphQLScalarType;
/**
 ...
 */
export type GraphQLBackendType = 'synthetic' | 'passthrough' | 'azureFunction' | 'appService' | 'custom';
/**
 * Backend credentials
 */
 ...
 */
export type SubscriptionTransport = 'websocket' | 'sse' | 'signalr' | 'eventgrid' | 'servicebus';
/**
 ...
 */
export type AuthenticationProviderConfig = AzureADAuthConfig | OAuth2AuthConfig | JwtAuthConfig | ApiKeyAuthConfig | CustomAuthConfig;
/**
...
export interface RateLimitingConfig {
    ...
    readonly customKeyGenerator?: string;
    readonly redis?: RedisConfig;
}
/**
 ...
 * Log destination
 */
export type LogDestination = 'console' | 'applicationInsights' | 'logAnalytics' | 'eventHub' | 'storageAccount';
/**
