...
export interface ResourceMetadata {
   ...
   * - generatedFromFallback: True if metadata was generated from fallback implementation
   *
  ...
  readonly metadata?: {
    ...
    /**
     * True if this metadata was generated from the fallback implementation.
     * Used for debugging and identifying resources that haven't been migrated
     * to provide custom toMetadata() implementations.
     *
     * When true, the metadata was generated by calling toArmTemplate() and
     * extracting information, which is slower than a custom implementation.
     *
     * @example true  // Generated from fallback
     */
    readonly generatedFromFallback?: boolean;
  };
}
