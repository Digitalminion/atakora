 ...
 * ```
 */
export declare class GrantError extends ValidationError {
    /**
 ...
 * ```
 */
export declare class MissingIdentityError extends GrantError {
    /**
 ...
 * ```
 */
export declare class InvalidRoleAssignmentError extends GrantError {
    /**
