...
import type { SubscriptionStack } from '../../core/subscription-stack';
import { ArmResourceGroup } from './arm-resource-group';
import type { ResourceGroupProps, IResourceGroup } from './types';
 ...
 * ```
 */
export class ResourceGroup extends Construct implements IResourceGroup {
  /**
   * Underlying L1 construct.
   */
  private readonly armResourceGroup: ArmResourceGroup;
