 ...
 * ```
 */
export class LogAnalyticsWorkspace extends Construct implements ILogAnalyticsWorkspace {
  /**
   * Underlying L1 construct.
   */
  private readonly armLogAnalyticsWorkspace: ArmLogAnalyticsWorkspace;
  ...
  constructor(
    ...
    this.armLogAnalyticsWorkspace = new ArmLogAnalyticsWorkspace(scope, `${id}-Resource`, {
