 ...
 * ```
 */
export class MetricAlert extends Construct implements IMetricAlert {
  /**
   * Underlying L1 construct.
   */
  private readonly armMetricAlert: ArmMetricAlert;
  ...
  constructor(scope: Construct, id: string, props: MetricAlertProps) {
    ...
    this.armMetricAlert = new ArmMetricAlert(scope, `${id}-Resource`, {
      name: this.name,
   ...
   */
  private buildCriteria(props: MetricAlertProps): any {
