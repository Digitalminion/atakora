...
import type { ManagedServiceIdentity } from '../../core/identity';
import { ManagedIdentityType } from '../../core/identity';
...
/**
 * Properties for ArmAppService (L1 construct).
 *
 * @remarks
 ...
 * ```
 */
export interface ArmAppServiceProps {
  /**
...
/**
 * Properties for AppService (L2 construct).
 *
 * @remarks
...
export interface AppServiceProps {
   ...
   * @remarks
   * Can be:
   * - IAppServicePlan interface (from AppServicePlan construct)
   * - String resource ID
   */
  readonly serverFarmId: IAppServicePlan | string;
