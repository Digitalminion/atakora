 ...
 * ```
 */
export class DiagnosticSetting extends Construct implements IDiagnosticSetting {
  private readonly armDiagnosticSetting: ArmDiagnosticSetting;
  ...
  constructor(scope: Construct, id: string, props: DiagnosticSettingProps) {
    ...
    this.armDiagnosticSetting = new ArmDiagnosticSetting(scope, `${id}-Resource`, {
      name: this.name,
  ...
  private buildLogSettings(props: DiagnosticSettingProps): LogSettings[] | undefined {
  ...
  private buildMetricSettings(props: DiagnosticSettingProps): MetricSettings[] | undefined {
