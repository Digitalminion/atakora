...
import { ArmApiManagement } from './arm-api-management';
import type {
  ApiManagementProps,
  IApiManagement,
 ...
 * ```
 */
export class ApiManagement extends Construct implements IApiManagement {
  /**
   * Underlying L1 construct.
   */
  private readonly armApiManagement: ArmApiManagement;
  ...
  constructor(scope: Construct, id: string, props: ApiManagementProps) {
    ...
    this.armApiManagement = new ArmApiManagement(scope, `${id}-Resource`, {
   ...
   */
  private resolveServiceName(id: string, props: ApiManagementProps): string {
   ...
   */
  private resolveSku(props: ApiManagementProps): ApiManagementSkuName {
   ...
   */
  private resolveCapacity(sku: ApiManagementSkuName, props: ApiManagementProps): number {
   ...
   */
  private buildSecurityProperties(props: ApiManagementProps): Record<string, string> | undefined {
