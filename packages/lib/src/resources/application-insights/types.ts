...
/**
 * Properties for ArmApplicationInsights (L1 construct).
 *
 * @remarks
 ...
 * ```
 */
export interface ArmApplicationInsightsProps {
  /**
...
/**
 * Properties for ApplicationInsights (L2 construct).
 *
 * @remarks
...
export interface ApplicationInsightsProps {
   ...
   * - Example: `appi-digital-products-colorai-main-nonprod-eus-01`
   *
