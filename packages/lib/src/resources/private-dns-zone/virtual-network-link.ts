...
import type { VirtualNetworkLinkProps, IVirtualNetworkLink } from './virtual-network-link-types';
 ...
 * ```
 */
export class VirtualNetworkLink extends Construct implements IVirtualNetworkLink {
  /**
  ...
  constructor(scope: Construct, id: string, props: VirtualNetworkLinkProps) {
    super(scope, id);
