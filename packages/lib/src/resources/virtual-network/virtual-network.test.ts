...
describe('resources/virtual-network/VirtualNetwork', () => {
  let app: App;
  ...
  describe('auto-naming', () => {
    ...
    it('should handle different construct ID formats', () => {
      ...
      testCases.forEach(({ id, expectedPurpose }) => {
        const vnet = new VirtualNetwork(resourceGroup, id, {
          addressSpace: '10.0.0.0/16',
        });
    ...
    it('should generate different names for different construct IDs', () => {
      const vnet1 = new VirtualNetwork(resourceGroup, 'MainVNet', {
        addressSpace: '10.0.0.0/16',
      });
      const vnet2 = new VirtualNetwork(resourceGroup, 'SecondaryVNet', {
  ...
  describe('parent validation', () => {
    it('should throw error if not created within a ResourceGroup', () => {
      ...
      expect(() => {
        new VirtualNetwork(plainConstruct, 'MainVNet', {
          addressSpace: '10.0.0.0/16',
        });
    ...
    it('should work when created within nested construct under ResourceGroup', () => {
      ...
      const vnet = new VirtualNetwork(nestedConstruct, 'MainVNet', {
        addressSpace: '10.0.0.0/16',
      });
  ...
  describe('integration tests', () => {
    ...
    it('should support different geographies', () => {
      ...
      const vnet = new VirtualNetwork(westRG, 'MainVNet', {
        addressSpace: '10.0.0.0/16',
      });
