import type { NamingConventions, NamingConventionConfig, ResourceNameParams, NameValidationResult } from './types';
import { type ScopedResourceNameParams } from './scoped-naming';
/**
 ...
 * ```
 */
export declare class ResourceNameGenerator {
     ...
     * ```
     */
    generateName(params: ResourceNameParams): string;
    /**
     ...
     * ```
     */
    validateName(name: string, resourceType: string): NameValidationResult;
    /**
     ...
     * ```
     */
    getPattern(resourceType: string): string;
    /**
     ...
     * ```
     */
    getMaxLength(resourceType: string): number;
    /**
     ...
     * ```
     */
    getConventions(): Readonly<NamingConventions>;
    /**
     ...
     * ```
     */
    willTruncate(name: string, resourceType: string): boolean;
    /**
     ...
     * ```
     */
    generateForScope(params: ScopedResourceNameParams): string;
}
