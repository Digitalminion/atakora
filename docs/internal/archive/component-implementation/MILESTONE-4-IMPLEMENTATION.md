...
export class StaticSiteWithCdn
  extends Construct
  implements IBackendComponent<StaticSiteWithCdnProps>
{
  ...
  public static define(
    id: string,
    config: StaticSiteWithCdnProps = {}
  ): IComponentDefinition<StaticSiteWithCdnProps> {
    return {
      componentId: id,
