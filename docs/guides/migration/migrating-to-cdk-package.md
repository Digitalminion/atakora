...
// Web & App Services
import { AppServicePlan, WebApp, StaticWebApp, FunctionApp } from '@atakora/cdk/web';
...
// Monitoring
import { ApplicationInsights, LogAnalyticsWorkspace, Component } from '@atakora/cdk/insights';
...
```typescript
import { VirtualNetworkProps, IVirtualNetwork } from '@atakora/cdk/network';

import { StorageAccountProps, IStorageAccount } from '@atakora/cdk/storage';
```
...
```typescript
import { StorageAccountKind, StorageAccountSku } from '@atakora/cdk/storage';

import { PrivateEndpointNetworkPolicies } from '@atakora/cdk/network';
```
...
```typescript
import { ArmVirtualNetwork, ArmStorageAccount } from '@atakora/lib';
```
...
import { AppServicePlan, WebApp, AppServicePlanSku } from '@atakora/cdk/web';
import { KeyVault, Secret } from '@atakora/cdk/keyvault';
