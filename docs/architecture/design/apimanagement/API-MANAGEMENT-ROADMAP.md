...
- [GraphQL Implementation Guide](../../docs/guides/graphql-apis.md) _(if exists)_
- [REST API Guide](../../docs/guides/rest-api.md)
- [API Management Fundamentals](../../docs/guides/fundamentals/api-management.md) _(if exists)_
