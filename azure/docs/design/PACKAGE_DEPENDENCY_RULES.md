...
- [ADR-021: Circular Dependency Audit](/azure/docs/design/architecture/adr-021-circular-dependency-audit.md)
- [Circular Dependency Audit Summary](/azure/docs/design/CIRCULAR_DEPENDENCY_AUDIT_SUMMARY.md)
- [ADR-020: Component Auth System](/azure/docs/design/architecture/adr-020-component-auth-system.md)
